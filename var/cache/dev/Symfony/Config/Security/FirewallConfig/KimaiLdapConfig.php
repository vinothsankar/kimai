...
class KimaiLdapConfig 
{
     ...
     * @default false
     * @param ParamConfigurator|bool $value
     * @deprecated Option "require_previous_session" at "kimai_ldap" is deprecated, it will be removed in version 7.0. Setting it has no effect anymore.
     * @return $this
     */
