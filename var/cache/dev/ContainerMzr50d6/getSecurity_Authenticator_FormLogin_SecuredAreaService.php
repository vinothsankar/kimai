...
class getSecurity_Authenticator_FormLogin_SecuredAreaService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authenticator.form_login.secured_area'])) {
            return $container->privates['security.authenticator.form_login.secured_area'];
        }
