...
class getDoctrine_Orm_Listeners_PdoSessionHandlerSchemaListenerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['App\\Security\\SessionHandler'] ?? $container->load('getSessionHandlerService'));

        if (isset($container->privates['doctrine.orm.listeners.pdo_session_handler_schema_listener'])) {
            return $container->privates['doctrine.orm.listeners.pdo_session_handler_schema_listener'];
        }

        return $container->privates['doctrine.orm.listeners.pdo_session_handler_schema_listener'] = new \Symfony\Bridge\Doctrine\SchemaListener\PdoSessionHandlerSchemaListener($a);
    }
}
