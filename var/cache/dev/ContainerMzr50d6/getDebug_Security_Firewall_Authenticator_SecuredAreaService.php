...
class getDebug_Security_Firewall_Authenticator_SecuredAreaService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['security.authenticator.manager.secured_area'] ?? $container->load('getSecurity_Authenticator_Manager_SecuredAreaService'));
        ...
        return $container->privates['debug.security.firewall.authenticator.secured_area'] = new \Symfony\Component\Security\Http\Authenticator\Debug\TraceableAuthenticatorManagerListener(new \Symfony\Component\Security\Http\Firewall\AuthenticatorManagerListener($a));
    }
}
