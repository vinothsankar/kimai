 ...
 */
class getTimesheetValidatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Validator\Constraints\TimesheetValidator' shared autowired service.
     *
     * @return \App\Validator\Constraints\TimesheetValidator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Validator'.\DIRECTORY_SEPARATOR.'Constraints'.\DIRECTORY_SEPARATOR.'TimesheetValidator.php';

        return $container->privates['App\\Validator\\Constraints\\TimesheetValidator'] = new \App\Validator\Constraints\TimesheetValidator(new RewindableGenerator(function () use ($container) {
