...
class getTagsInputTypeService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Form\\Type\\TagsInputType'] = new \App\Form\Type\TagsInputType(($container->privates['App\\Repository\\TagRepository'] ?? $container->load('getTagRepositoryService')), ($container->services['router'] ?? self::getRouterService($container)));
    }
}
