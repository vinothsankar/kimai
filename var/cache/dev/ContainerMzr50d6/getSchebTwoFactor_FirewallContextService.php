...
class getSchebTwoFactor_FirewallContextService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['scheb_two_factor.firewall_context'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\TwoFactorFirewallContext(['secured_area' => ($container->privates['security.firewall_config.two_factor.secured_area'] ?? self::getSecurity_FirewallConfig_TwoFactor_SecuredAreaService($container))]);
    }
}
