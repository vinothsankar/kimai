 ...
 */
class getTimesheetVoterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private '.debug.security.voter.App\Voter\TimesheetVoter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Voter'.\DIRECTORY_SEPARATOR.'TimesheetVoter.php';

        $a = ($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container));

        if (isset($container->privates['.debug.security.voter.App\\Voter\\TimesheetVoter'])) {
            return $container->privates['.debug.security.voter.App\\Voter\\TimesheetVoter'];
        }

        return $container->privates['.debug.security.voter.App\\Voter\\TimesheetVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(new \App\Voter\TimesheetVoter(($container->privates['App\\Security\\RolePermissionManager'] ?? $container->load('getRolePermissionManagerService')), ($container->privates['App\\Timesheet\\LockdownService'] ?? $container->load('getLockdownServiceService'))), $a);
    }
}
