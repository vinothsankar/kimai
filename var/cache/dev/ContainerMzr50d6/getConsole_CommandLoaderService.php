...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Command\\ActivateUserCommand' => ['privates', 'App\\Command\\ActivateUserCommand', 'getActivateUserCommandService', true],
            'App\\Command\\ChangePasswordCommand' => ['privates', 'App\\Command\\ChangePasswordCommand', 'getChangePasswordCommandService', true],
            'App\\Command\\CreateUserCommand' => ['privates', 'App\\Command\\CreateUserCommand', 'getCreateUserCommandService', true],
            'App\\Command\\DeactivateUserCommand' => ['privates', 'App\\Command\\DeactivateUserCommand', 'getDeactivateUserCommandService', true],
            'App\\Command\\DemoteUserCommand' => ['privates', 'App\\Command\\DemoteUserCommand', 'getDemoteUserCommandService', true],
            'App\\Command\\ExportCreateCommand' => ['privates', 'App\\Command\\ExportCreateCommand', 'getExportCreateCommandService', true],
            'App\\Command\\InstallCommand' => ['privates', '.App\\Command\\InstallCommand.lazy', 'getInstallCommand_LazyService', true],
            'App\\Command\\InvoiceCreateCommand' => ['privates', 'App\\Command\\InvoiceCreateCommand', 'getInvoiceCreateCommandService', true],
            'App\\Command\\ListUserCommand' => ['privates', '.App\\Command\\ListUserCommand.lazy', 'getListUserCommand_LazyService', true],
            'App\\Command\\MailTestCommand' => ['privates', '.App\\Command\\MailTestCommand.lazy', 'getMailTestCommand_LazyService', true],
            'App\\Command\\PluginCommand' => ['privates', '.App\\Command\\PluginCommand.lazy', 'getPluginCommand_LazyService', true],
            'App\\Command\\PromoteUserCommand' => ['privates', 'App\\Command\\PromoteUserCommand', 'getPromoteUserCommandService', true],
            'App\\Command\\RegenerateLocalesCommand' => ['privates', '.App\\Command\\RegenerateLocalesCommand.lazy', 'getRegenerateLocalesCommand_LazyService', true],
            'App\\Command\\ReloadCommand' => ['privates', 'App\\Command\\ReloadCommand', 'getReloadCommandService', true],
            'App\\Command\\ResetDevelopmentCommand' => ['privates', '.App\\Command\\ResetDevelopmentCommand.lazy', 'getResetDevelopmentCommand_LazyService', true],
            'App\\Command\\ResetTestCommand' => ['privates', '.App\\Command\\ResetTestCommand.lazy', 'getResetTestCommand_LazyService', true],
            'App\\Command\\TimesheetStopAllCommand' => ['privates', 'App\\Command\\TimesheetStopAllCommand', 'getTimesheetStopAllCommandService', true],
            'App\\Command\\TranslationCommand' => ['privates', 'App\\Command\\TranslationCommand', 'getTranslationCommandService', true],
            'App\\Command\\UserLoginLinkCommand' => ['privates', '.App\\Command\\UserLoginLinkCommand.lazy', 'getUserLoginLinkCommand_LazyService', true],
            'App\\Command\\VersionCommand' => ['privates', 'App\\Command\\VersionCommand', 'getVersionCommandService', true],
            ...
            'App\\Command\\ActivateUserCommand' => 'App\\Command\\ActivateUserCommand',
            'App\\Command\\ChangePasswordCommand' => 'App\\Command\\ChangePasswordCommand',
            'App\\Command\\CreateUserCommand' => 'App\\Command\\CreateUserCommand',
            'App\\Command\\DeactivateUserCommand' => 'App\\Command\\DeactivateUserCommand',
            'App\\Command\\DemoteUserCommand' => 'App\\Command\\DemoteUserCommand',
            'App\\Command\\ExportCreateCommand' => 'App\\Command\\ExportCreateCommand',
            'App\\Command\\InstallCommand' => '?',
            'App\\Command\\InvoiceCreateCommand' => 'App\\Command\\InvoiceCreateCommand',
            'App\\Command\\ListUserCommand' => '?',
            'App\\Command\\MailTestCommand' => '?',
            'App\\Command\\PluginCommand' => '?',
            'App\\Command\\PromoteUserCommand' => 'App\\Command\\PromoteUserCommand',
            'App\\Command\\RegenerateLocalesCommand' => '?',
            'App\\Command\\ReloadCommand' => 'App\\Command\\ReloadCommand',
            'App\\Command\\ResetDevelopmentCommand' => '?',
            'App\\Command\\ResetTestCommand' => '?',
            'App\\Command\\TimesheetStopAllCommand' => 'App\\Command\\TimesheetStopAllCommand',
            'App\\Command\\TranslationCommand' => 'App\\Command\\TranslationCommand',
            'App\\Command\\UserLoginLinkCommand' => '?',
            'App\\Command\\VersionCommand' => 'App\\Command\\VersionCommand',
