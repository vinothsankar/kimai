 ...
 */
class getSecurity_Listener_LoginThrottling_SecuredAreaService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.listener.login_throttling.secured_area' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.listener.login_throttling.secured_area'] = new \Symfony\Component\Security\Http\EventListener\LoginThrottlingListener(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Symfony\Component\Security\Http\RateLimiter\DefaultLoginRateLimiter(new \Symfony\Component\RateLimiter\RateLimiterFactory(['policy' => 'fixed_window', 'limit' => 25, 'interval' => '5 minutes', 'id' => '_login_global_secured_area'], new \Symfony\Component\RateLimiter\Storage\CacheStorage($a), NULL), new \Symfony\Component\RateLimiter\RateLimiterFactory(['policy' => 'fixed_window', 'limit' => 5, 'interval' => '5 minutes', 'id' => '_login_local_secured_area'], new \Symfony\Component\RateLimiter\Storage\CacheStorage($a), NULL), $container->getEnv('APP_SECRET')));
    }
}
