...
class getSchebTwoFactor_Security_TotpAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['scheb_two_factor.security.totp_authenticator'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\Totp\TotpAuthenticator(($container->services['scheb_two_factor.security.totp_factory'] ??= new \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\Totp\TotpFactory(NULL, 'Kimai', [])), 1, 29);
    }
}
