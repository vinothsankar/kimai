...
{
    /**
     * Gets the private '.debug.security.voter.App\Voter\ProjectVoter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Voter'.\DIRECTORY_SEPARATOR.'ProjectVoter.php';

        $a = ($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container));

        if (isset($container->privates['.debug.security.voter.App\\Voter\\ProjectVoter'])) {
            return $container->privates['.debug.security.voter.App\\Voter\\ProjectVoter'];
        }

        return $container->privates['.debug.security.voter.App\\Voter\\ProjectVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(new \App\Voter\ProjectVoter(($container->privates['App\\Security\\RolePermissionManager'] ?? $container->load('getRolePermissionManagerService'))), $a);
    }
}
