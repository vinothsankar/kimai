 ...
 */
class getQuickEntryVoterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private '.debug.security.voter.App\Voter\QuickEntryVoter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Voter'.\DIRECTORY_SEPARATOR.'QuickEntryVoter.php';

        $a = ($container->privates['App\\Timesheet\\TrackingModeService'] ?? $container->load('getTrackingModeServiceService'));

        if (isset($container->privates['.debug.security.voter.App\\Voter\\QuickEntryVoter'])) {
            return $container->privates['.debug.security.voter.App\\Voter\\QuickEntryVoter'];
        }
        ...
        return $container->privates['.debug.security.voter.App\\Voter\\QuickEntryVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(new \App\Voter\QuickEntryVoter(($container->privates['App\\Security\\RolePermissionManager'] ?? $container->load('getRolePermissionManagerService')), $a), $b);
    }
}
