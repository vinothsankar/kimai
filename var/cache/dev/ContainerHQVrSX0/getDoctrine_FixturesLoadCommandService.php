...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'AllFixtures.php';
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'InvoiceFixtures.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'TagFixtures.php';
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'TimesheetFixtures.php';
        ...
        $a->addFixtures([['fixture' => new \App\DataFixtures\AllFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\CustomerFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\InvoiceFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\TagFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\TeamFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\TimesheetFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\UserFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService'))), 'groups' => []]]);
